...
import { ROAD_TRIP_GAMES, USA_TRIVIA } from './data/sampleEntertainment'
  ...
  function vote(songId: string, voteType: 'up' | 'down') {
    ...
    const newVotes =
      existing?.vote === voteType
        ? filtered
        : [...filtered, { member_id: memberId, vote: voteType }]
              ...
              >
                ...
                <div className="flex items-center gap-1 shrink-0">
                  <button
                    ...
                    className={cn(
                      'rounded-lg p-1.5',
                      myVote === 'up' ? 'bg-ios-green/20 text-ios-green' : 'text-apple-tertiary',
                    )}
                  >
                  ...
                  <button
                    ...
                    className={cn(
                      'rounded-lg p-1.5',
                      myVote === 'down' ? 'bg-ios-red/20 text-ios-red' : 'text-apple-tertiary',
                    )}
                  >
            ...
            <div key={game.id} className="glass rounded-apple-lg p-4 shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-sm text-apple-secondary leading-relaxed">
                    {game.description}
                  </p>
            ...
            {USA_TRIVIA.map((_, i) => (
              <div
                ...
                className={cn(
                  ...
                  i === triviaIndex ? 'bg-ios-teal' : 'bg-black/[0.04]',
                )}
              />
            ))}
          </div>
