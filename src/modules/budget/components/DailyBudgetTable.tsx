...
const DAY_OVERRIDES: Record<string, Partial<Record<BudgetRowKey, number>>> = {
  'day-1': {
    ...
    tips: 8,
    unexpected: 15,
  }, // Newark hotel (DoubleTree Newark Airport, $265.30 confirmed), afternoon arrival only
  'day-2': {
    accommodation: 40,
    gas: 35,
    food: 60,
              ...
              return (
                <div key={day.id} className="rounded-lg border border-black/[0.06] overflow-hidden">
                  ...
                  <button
                    ...
                    className="flex w-full items-center gap-2 px-3 py-2.5 min-h-[44px] bg-black/[0.02] active:bg-black/[0.04]"
                  >
