...
export const LOCATIONS: LocationDef[] = [
  ...
  },
  {
    ...
    type: 'town',
    summary:
      'שער הכניסה ליילוסטון! עיירה מקסימה במונטנה שמוקפת בהרים. כאן אוספים את הקרוואן ומתחילים את ההרפתקה הגדולה.',
    funFact:
      '🤖 ידעתם? גרדינר היא הכניסה היחידה ליילוסטון שפתוחה כל השנה — ושם הקשת של רוזוולט מ-1903!',
  },
  {
    id: 'yellowstone',
    name: 'Yellowstone',
    ...
    type: 'park',
    summary:
      'הפארק הלאומי הראשון בעולם! גייזרים, מעיינות חמים בצבעי קשת, דובי גריזלי, ביזונים — מקום שנראה כאילו הוא מכוכב אחר.',
    funFact:
      '🤖 ידעתם? יילוסטון יושב על סופר-וולקנו ענק! Old Faithful פולט 30,000 ליטר מים רותחים כל 90 דקות כבר מאות שנים!',
  },
  {
    id: 'grand-teton',
    name: 'Grand Teton',
    ...
    type: 'park',
    summary:
      'הפסגות הכי דרמטיות ברוקיס! ההרים עולים ישר מהעמק, אגמים צלולים כמראה, ולוסים שמסתובבים ברחוב. טבע פראי בשיאו.',
    funFact:
      '🤖 ידעתם? רכס הטיטון קיבל את שמו מציידי פרוות צרפתיים ב-1800 — והשם אומר... בואו נגיד שהם היו יצירתיים 😏',
  },
  {
    id: 'jackson',
    name: 'Jackson',
    ...
    type: 'town',
    summary:
      'עיירת הרים קסומה למרגלות הטיטון! כיכר הקרניים המפורסמת, רפטינג על נהר סנייק, רכבל ועשרות מסעדות ובוטיקים.',
    funFact:
      '🤖 ידעתם? ג\'קסון הול הוא אחד המקומות היקרים ביותר בארה"ב — מחירי נדל"ן גבוהים יותר מבוורלי הילס!',
  },
  {
    id: 'anthony-chabot',
    name: 'Anthony Chabot',
    ...
    type: 'park',
    summary:
      'פארק אזורי יפהפה בגבעות אוקלנד! קמפינג מוקף ביער אקליפטוס, אגם שקט, ונוף לאזור מפרץ סן פרנסיסקו.',
  ...
  },
  {
    ...
    type: 'park',
    summary:
      'עמודי הודו (Hoodoos) — תצורות סלע מדהימות שנראות כאילו הגיעו מכוכב אחר. הזריחה כאן היא מהמרהיבות בעולם!',
    funFact:
      '🤖 ידעתם? ברייס קניון הוא לא באמת קניון — הוא אמפיתיאטר טבעי ענק שנשחק ע"י גשם וקרח לאורך מיליוני שנים!',
  },
  {
    id: 'zion',
    ...
    type: 'park',
    summary:
      "קניונים אדומים מרהיבים, מסלולי הליכה לכל הרמות, ונהר הווירג'ין שזורם בתוך הקניון. חובה: Angels Landing או Narrows.",
    funFact:
      '🤖 ידעתם? שם הפארק "ציון" ניתן לו על ידי מתיישבים מורמונים ב-1860 — הם חשבו שזה נראה כמו גן עדן!',
  },
  {
    id: 'las-vegas',
    name: 'Las Vegas',
    ...
    type: 'city',
    summary:
      'הנה, ויגאס! גם עם ילדים יש פה מלא מה לעשות — שואו של Cirque du Soleil, הרצפת זכוכית ב-Stratosphere, ומדבר נבדה ממש מעבר לפינה.',
  ...
  },
  {
    ...
    type: 'town',
    summary:
      'אתר סקי מפורסם שבקיץ הופך לגן עדן של טיולים ואגמים. מעיינות חמים, אגמי הרים צלולים, ונוף וולקני מרשים.',
    funFact:
      "🤖 ידעתם? האגמי הרים באזור מאמות' הם כל כך צלולים שאפשר לראות את הקרקעית ב-30 מטר עומק!",
  },
  {
    id: 'yosemite',
    name: 'Yosemite',
    ...
    coordinates: { lat: 37.749, lng: -119.5885 },
    type: 'park',
    summary:
      'אחד הפארקים הלאומיים המפורסמים בעולם! מפלי ענק, צוקים מרשימים, ועצי סקויה עתיקים. El Capitan ו-Half Dome — האייקונים של קליפורניה.',
    funFact:
      '🤖 ידעתם? מפל יוסמיטי הוא המפל הגבוה ביותר בצפון אמריקה — 739 מטר, כמעט פי 7 ממפלי הניאגרה!',
  },
  {
    id: 'san-francisco',
    name: 'San Francisco',
    ...
    type: 'city',
    summary:
      'העיר האחרונה בטיול! גשר הזהב, הרכבלים, רציף הדייגים ואלקטרז. עיר עם אופי מיוחד, ערפל מפורסם ואוכל מדהים.',
    funFact:
      '🤖 ידעתם? כבלי הרכבלים של סן פרנסיסקו הם מערכת התחבורה האחרונה מסוגה בעולם — ופועלים מאז 1873!',
  },
]
...
export function getLocationsForCity(city?: string): LocationDef[] {
  if (!city) return []
  return LOCATIONS.filter((loc) => loc.matchPatterns.some((pattern) => city.includes(pattern)))
}
...
export function getDaysForLocation(locationId: string, days: ItineraryDay[]): ItineraryDay[] {
  ...
  if (!location) return []
  return days.filter((day) => location.matchPatterns.some((pattern) => day.city?.includes(pattern)))
}

/** Match a campsite booking area string to a location ID */
export function getLocationForArea(area: string): LocationDef | undefined {
  return LOCATIONS.find((loc) => loc.matchPatterns.some((pattern) => area.includes(pattern)))
}
